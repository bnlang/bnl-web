...
- **Batteries included.** File I/O, HTTP/WebSocket server and client, templating, crypto, timers, JSON, regex — all in the standard library. Databases (SQLite, PostgreSQL, MongoDB, MySQL) ship as separate bpm packages.
...
- **ব্যাটারি ইনক্লুডেড।** ফাইল I/O, HTTP/WebSocket সার্ভার ও ক্লায়েন্ট, টেমপ্লেটিং, ক্রিপ্টো, টাইমার, JSON, regex — সবই স্ট্যান্ডার্ড লাইব্রেরিতে। ডাটাবেস (SQLite, PostgreSQL, MongoDB, MySQL) আলাদা bpm প্যাকেজ হিসেবে আসে।
