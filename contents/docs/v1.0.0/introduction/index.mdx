...
- **Batteries included.** File I/O, HTTP/WebSocket server and client, templating, SQLite/PostgreSQL/MongoDB, crypto, timers, JSON, regex — all in the standard library.
...
- **SQLite / libpq / mongo-c-driver** — embedded SQLite and first-class clients for PostgreSQL and MongoDB.
- **zlib** — gzip/deflate.
