...
## What is Bnlang?
**Bnlang** is the Bangla Programming Language that lets you write code in **Bangla**, **English**—side by side.  
...
## How Bnlang works
Bnlang code is parsed and executed by a runtime that understands multiple keyword sets (Bangla/English) but maps them to the same semantics.  
...
- Docs are versioned: `/docs/v1.0.0/...` with locale segments for Bangla and English.
