---
title: var keyword
description: Declaring variables in Bnlang with `var` / `চলক` / `ধরি`. Scope, reassignment, and shadowing.

bnTitle: চলক কীওয়ার্ড
bnDescription: Bnlang-এ `var` / `চলক` / `ধরি` দিয়ে ভ্যারিয়েবল ডিক্লেয়ারেশন — স্কোপ, পুনঃঅ্যাসাইনমেন্ট, ছায়াদান।
---
...
The Bangla forms `চলক` and `ধরি` are exactly equivalent — pick whichever reads more naturally.
