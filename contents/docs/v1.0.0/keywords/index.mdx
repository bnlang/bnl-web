...
Many of these have an equivalent built-in or library function — see the **Operators** page and the **Get Started** guide in *Learn*.
</I18nEnglish>
...
এদের অনেকের সমতুল্য বিল্ট-ইন বা লাইব্রেরি ফাংশন আছে — **Operators** পেজ এবং *Learn*-এ **Get Started** গাইড দেখুন।
</I18nBangla>
