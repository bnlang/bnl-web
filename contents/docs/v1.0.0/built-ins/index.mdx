...
# <I18nBanglish>Bnlang Builtins</I18nBanglish>
...
<I18nBanglish>
Ekhane Bnlang er **shob built‑in** ek jaygay—global value/function ar JS standard object gulo—**English/Bangla/Banglish** tin nam e deya.  
...
<I18nBanglish>
- Protiti builtin‑e **English**, **Bangla**, **Banglish** nam cholbe.  
- Vitore sob ek‑i jinis; file er language onujayi nam nin.  
- Ei doke amra egulo “available names” hisebe dekhacchi.
</I18nBanglish>
...
<I18nBanglish>
- **One‑style‑per‑file:** ek file e eki style maintain korun.  
- **Strict compare:** `===` / `!==`.  
- **Module agnostic:** ESM/CJS e same.  
- **Console short:** `chapao/dekhao/likho/print` → `console.log(...)`.
</I18nBanglish>
...
```bnl
// Values
console.log(asongyayito, sonkhaNoy, oshim);

// Functions
console.log(soshimKi(10), sonkhaNoyKi(sonkhaNoy));
console.log(purnoshonkhaTeRupantor("42", 10), voghnangsheRupantor("3.14"));
console.log(uriEncode("https://ex.com?q=ha"));
khudroKajerSari(() => console.log("microtask ran"));
```
  </TabsContent>
</Tabs>
...
<I18nBanglish>
- File‑e **ek style** e thakun.  
- Jotil logic helper‑e tulun; early return bhalo.  
- Iterable‑e `for…of` use korun; WeakMap/WeakSet enumerate hoy na.  
- Date/number/string er built‑in method use korun.
</I18nBanglish>
