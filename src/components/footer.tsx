...
export function Footer({
  ...
  return (
    <footer className="text-gray-700 border-t">
      <div
        className={`${isFullWidth ? "w-full" : "max-w-7xl"
        ...
        <div className="grid grid-cols-1 md:grid-cols-4 gap-8">
          <div className="md:col-span-1">
            ...
            <div className="flex gap-5">
              ...
              <a
                href="mailto:info@bnlang.dev"
                title="Email us"
                className=" transition-colors"
              >
                <svg xmlns="http://www.w3.org/2000/svg" width="16" height="16" className="w-6 h-6" fill="currentColor" viewBox="0 0 16 16">
          ...
          <div>
            <h3
              className={`font-semibold mb-4 ${locale === "bn" ? "font-bn" : ""
                }`}
            >
